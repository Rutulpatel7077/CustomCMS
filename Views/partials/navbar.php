	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			<ul class="nav navbar-nav navbar-right">
                <li class=<?php echo ($title == "About Us") ? "active" : "" ?>><a href="index.php?pageId=About">About Us</a></li>
                <li class=<?php echo ($title == "Contact Us") ? "active" : "" ?>><a href="index.php?pageId=Contact">Contact Us</a></li>
